...
ENDPOINT_OUTPUT_DEFAULT: Final = "/audio/outputs/{output}/default"
...
SSE_EVENT_AUDIO_OUTPUT_UPDATED: Final = "audio.output.updated"
SSE_EVENT_AUDIO_OUTPUT_REMOVED: Final = "audio.output.removed"
...
SSE_EVENT_BLUETOOTH_DISCOVERED: Final = "bluetooth.discovered"
