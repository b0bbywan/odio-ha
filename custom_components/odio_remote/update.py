...
class OdioUpdateEntity(CoordinatorEntity[OdioUpgradeCoordinator], UpdateEntity):
    ...
    _attr_translation_key = "software"
    ...
    def __init__(
        ...
        self._attr_unique_id = f"{entry_id}_software_update"
    ...
    def latest_version(self) -> str | None:
        ...
        the device as up to date.
        """
        data = self.coordinator.data or {}
        if data.get("upgrade_available"):
            return data.get("latest") or self.installed_version
